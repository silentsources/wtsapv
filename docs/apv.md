...
Wij, de Hoge Raad der Eindhoven, bij de gratie Gods, enz., enz., enz.

Allen die deze zullen zien of horen lezen, salut! doen te weten:

Aangezien wij in overweging hebben genomen dat het noodzakelijk is een nieuwe **Algemene Plaatselijke Verordening Eindhoven (APV)** vast te stellen:

**Zo is het dat wij, de staff der Eindhoven, gehoord en met gemeen overleg van de Hoge Raad, hebben goedgevonden en verstaan, gelijk wij goedvinden en verstaan bij deze, vast te stellen de navolgende bepalingen, welke zullen uitmaken de Algemene Plaatselijke Verordening Eindhoven.**

| **Kenmerk**                | **Details**                          |
|----------------------------|--------------------------------------|
| Overheidsorganisatie       | Staff der Eindhoven                |
...
Het Wetboek van Strafrecht, specifiek bedoeld voor Eindhoven, wordt hierbij overschreven door deze APV.
...
1. Deze Algemene Plaatselijke Verordening, hierna te noemen **APV**, is bedoeld als aanvulling op het Nederlands Recht en heeft betrekking op het eiland, de gemeente en de stad Eindhoven.
...
2. Het is niet toegestaan externe discords te gebruiken voor roleplay-gerelateerde zaken zonder toestemming van de staff.
    ...
    * Tijdens voicechats met andere spelers van Eindhoven geldt:
    ...
    * In calls zitten met je vrienden die geen Eindhoven spelen is ook verboden.
...
4. Officiële Eindhoven-kleding, bedoeld voor specifieke groeperingen, mag niet door anderen worden gebruikt of als startkleding worden gekozen, tenzij er een sterke en goedgekeurde roleplay aan verbonden is.
5. Kleding die aangekocht is via de Eindhoven website mag wel gedragen worden door iedereen. (Op eigen risico)
...
1. De voertalen op Eindhoven zijn **Nederlands** en **Engels**.
...
1. Het gebruik van beledigingen met betrekking tot relevante/hedendaagse ziektes, racistische of ongepaste opmerkingen is verboden op alle door Eindhoven erkende platformen.
...
4. Alle overeenkomsten met betrekking tot loodsen moeten schriftelijk worden vastgelegd en gedocumenteerd in de stad Eindhoven met het commando /docu, en dienen te worden ondertekend door alle betrokken partijen.
...
---
APV opgesteld uit naam van de Hoge Raad, bedoeld voor het eiland, de gemeente en de stad “Tedeapolis”, opgetekend door Jordy Kolb, te Eindhoven.