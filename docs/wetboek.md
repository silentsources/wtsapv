...
| | |
|---|---|
| Overheidsorganisatie      | Hoge Raad Sunstone |
| Officiële naam            | Algemeen Wetboek Sunstone |
| Citeertitel               | Wetboek Sunstone |
...
1. Het Wetboek Sunstone (verder aangeduid als WSUN) is leidend voor alle beschreven gevallen, waarbij als aanvulling het Nederlands Recht van toepassing is.
2. Het WSUN heeft betrekking op het vaste land, de gemeente, en de stad Sunstone.
3. Het WSUN is nauw verweven met de Algemene Plaatselijke Verordening Sunstone (APV). De APV dient echter als een indicerend kader voor eventuele bestraffing in-game (“in RP”) en is verder bedoeld voor het afhandelen van straffen buiten de RP om.
...
3. Minderjarigen worden binnen Sunstone op dezelfde manier behandeld als volwassenen. Alle bepalingen, straffen en dergelijke zijn ook van toepassing op hen. Minderjarigen hebben dezelfde rechten en plichten als volwassenen. Het jeugdstrafrecht is in Sunstone niet van toepassing.
...
3. Geldige redenen voor inbeslagname zijn:
    1. Plegen van een strafbaar feit uit het wetboek van Sunstone waarbij het goed direct of indirect betrokken is, behalve fout parkeren en een snelheidsovertreding met uitzondering zoals beschreven in lid E van dit artikel;
...
---------------------
*Wetboek Sunstone is opgesteld uit naam van de Hoge Raad, bedoeld voor de gemeente en de stad “Sunstone”, opgetekend door Silent Sources, te Sunstone.*