...
| | |
|---|---|
| Overheidsorganisatie      | Hoge Raad Wave |
...
3. Het WWRP is nauw verweven met de Algemene Plaatselijke Verordening TedeaWavepolis (APV). De APV dient echter als een indicerend kader voor eventuele bestraffing in-game (“in RP”) en is verder bedoeld voor het afhandelen van straffen buiten de RP om.
